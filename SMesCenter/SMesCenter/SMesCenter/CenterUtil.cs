...
namespace SMesCenter
{
    class CenterUtil
    {
        ...
        public static List<string> GetNewUserAsssembles(string userId)
        {
            ...
            DataTable dt = SqlHelper.ExecuteDataTable(Sql.CenterSql.GetUserRefAssembles(userId),CommandType.Text);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        public static List<string> GetNewUserAsssemblesORACLE(string userId)
        {
            DataTable dt = SMes.Core.Service.DataBaseAccess.GetQueryData(Sql.CenterSql.GetUserRefAssembles(userId));
        ...
        public static void InsertEntryLog(string userId, string functionId, string orgId)
        {
          ...
          //  SMes.Core.Service.DataBaseAccess.DBExecute(sql);
				...
				public static void UpdateFunctionUseNum(string userId, string functionId, string functionname)
				{

					string sql = Sql.CenterSql.UpdateFunctionUseNum(userId, functionId, functionname);
					SqlHelper.ExecuteNonQuery(sql, CommandType.Text, null);
					//  SMes.Core.Service.DataBaseAccess.DBExecute(sql);
				}
        public static void UpdateFunctionUseNumold(string userId, string functionId,string functionname ,string orgId)
        {

            string sql = Sql.CenterSql.UpdateFunctionUseNumold(userId, orgId, functionId,functionname);
            SqlHelper.ExecuteNonQuery(sql, CommandType.Text, null);
            //  SMes.Core.Service.DataBaseAccess.DBExecute(sql);
        }
        public static void InsertEntryLog_New(string userId, string functionId, string functionName,string orgId)
        {

            string sql = Sql.CenterSql.GetAssemblyEntryInsertSql_New(userId, orgId, functionId,functionName);
            SqlHelper.ExecuteNonQuery(sql, CommandType.Text, null);
            //  SMes.Core.Service.DataBaseAccess.DBExecute(sql);
        }
