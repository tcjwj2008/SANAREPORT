...
public class BusiFileUploadService extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
	    ...
	    out.println("file will be upload to this folder:" + Configuration.BUSI_UPLOAD_PATH);
    ...
    throws ServletException, IOException {
		...
		dfif.setRepository(new File(Configuration.BUSI_UPLOAD_PATH+folder));
		...
		while (fileItr.hasNext()) {
			...
			String prefix = path;
			String u_name = Configuration.BUSI_UPLOAD_PATH+folder+ prefix;
			try {
				...
				if(oldFile.exists())
				{
					...
					//oldFile.renameTo(new File(Configuration.BUSI_UPLOAD_PATH+folder+ prefix+".bak."+timePre));
					oldFile.delete();
				}
